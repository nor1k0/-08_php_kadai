...
(6, '2023-01-02 17:47:52', '', '', '', '2022-12-06', 'S：受注'),
...
(30, '2023-01-02 17:47:58', '和田', 'abc@co.jp', 'あいうえお商事', '2022-12-15', 'S：受注'),
...
--
ALTER TABLE `gs_bm_table`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=283;
COMMIT;
